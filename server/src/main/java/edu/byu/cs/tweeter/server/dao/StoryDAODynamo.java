...
public class StoryDAODynamo implements BaseService.StoryDAO
{
    ...
    @Override
    public PostStatusResponse addToStory(Status status, String userHandle, long timestamp)
    {
        DynamoUtils dynamoUtils = new DynamoUtils(STORY_TABLE);
        Item item = new Item()
    ...
    public GetStoryResponse getStory(String alias, Status lastStatus, int limit)
    {
        DynamoUtils dynamoUtils = new DynamoUtils(STORY_TABLE);
